# Exercise 4: History Cleanup

Jetzt geht es nicht mehr nur um "funktioniert", sondern um lesbare History.
...
- mehrere Commits per Rebase squashen

Variante B:

- Commits so lassen und im Plenum vergleichen
